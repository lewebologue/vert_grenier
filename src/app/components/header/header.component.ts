      ...
      <div class="nav-logo-block">
        <div class="nav-logo-circle">
          <svg viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="17" y="14.5" text-anchor="middle" font-family="Georgia,serif" font-size="7" font-weight="bold" fill="white">
              Vert
            </text>
            <text x="17" y="23" text-anchor="middle" font-family="Georgia,serif" font-size="7" font-weight="bold" fill="white">
              Grenier
            </text>
          </svg>
        </div>
